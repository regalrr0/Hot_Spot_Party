 ...
 */
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor>, OnItemSelectedListener {
    ...
    private EditText mPasswordView, cPassword, lname, fname, age;
