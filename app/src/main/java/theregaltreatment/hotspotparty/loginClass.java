...
public class loginClass  extends AsyncTask<String,Void,String>{
    ...
    public loginClass(Context context,TextView statusField,TextView roleField,int flag) {
    ...
    protected String doInBackground(String... arg0) {
        if(byGetOrPost == 0){ //means by Get Method
            try{
                ...
                String link = "hive.sewanee.edu/evansdb0/android/login.php";
                ...
                /*HttpURLGet request = new HttpGet();
